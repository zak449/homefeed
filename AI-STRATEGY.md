...
- Document processing (contracts, disclosures)
- Agent matching & transaction automation

### What AI CANNOT Do
- Know the basement flooded 3 times
- Know the neighbors fight at 2am
- Know the previous owner cut corners on the renovation
- Know a homeless shelter is being planned for the block
- Know the real reason a property is priced low
- Know which block is actually safe vs which one looks safe on paper
...
## 2. The Agentic AI Path

### Year 1-2: Build the Data Moat (2026-2027)
...
- Hedge funds & REITs: block-level sentiment for investment decisions
...
| Month 24 | 45 people | 11 people |

### AI Coverage by Function
- **QA & Testing**: 100% AI-automated
- **Data Pipelines**: 100% AI-managed
- **Customer Support**: 90% AI (human escalation only)
- **Content Moderation**: 95% AI + verified local flagging
- **Marketing Content**: 80% AI-generated, human-edited
- **Campaign Analysis**: 100% AI-analyzed
...
## 4. The Data Moat (Why This Gets More Valuable Over Time)

### Network Effects
More verified residents → More takes → More value → More residents → More data → Higher licensing revenue

### What Makes This Data Unique
1. **Verified**: Every contributor's address is confirmed
2. **Geo-locked**: Data is tied to specific zip codes and blocks
3. **Human-generated**: Can't be scraped or synthesized by AI
4. **Sentiment-rich**: Not just facts — emotions, warnings, endorsements
5. **Temporal**: Comments tied to specific listing lifecycles

### Who Pays for This Data
| Buyer | Use Case | Pricing Model |
|-------|----------|---------------|
| Hedge Funds & REITs | Block-level sentiment for investments | Per-zip subscription |
| Insurance Companies | Community-reported risk assessment | Per-query API |
| City Planners | Neighborhood sentiment for development | Annual license |
| AI Companies | Training data for real estate models | Data licensing deal |
| Mortgage Lenders | Community validation for underwriting | Per-transaction fee |

### Market Size
- Alternative data market: **$17.4B by 2027** (Grand View Research)
- Real estate data specifically: **$3.2B** and growing
- PropTech data licensing: **$85K per zip code** (industry comp)
...
| Redfin goes full AI | Still can't replace verified neighbor warnings. |
| Google integrates real estate | They have maps. We have the people who live there. |

**"We don't compete with AI. We feed it."**
...
### The Investment Case
- $1.5M SAFE, $10M post-money cap
- Cash-flow positive by Month 18
- Data licensing revenue starts Month 6-12
- The community builds itself — zero paid acquisition needed
- AI-native team = 60% lower burn than competitors
- Multiple exit paths: acquisition (Zillow, Redfin), data licensing, or IPO

---

*"AI replaces search. AI replaces agents. AI cannot replace your neighbor. We own that data."*
