...
const faqs = [
  {
    question: "What is homefeed?",
    answer:
      "homefeed is the social layer for real estate. Think of it like a comment section for every listing on the market. We aggregate real estate listings and let real people \u2014 neighbors, buyers, renters, agents, and curious locals \u2014 weigh in with opinions, reactions, and hot takes. It\u2019s browsing homes, but make it social.",
  },
  {
    question: "How is this different from Zillow or Redfin?",
    answer:
      "Zillow and Redfin are great for facts: price, square footage, how many bedrooms. But they don\u2019t tell you what people actually think. Is $800K overpriced for that neighborhood? Is that \u201ccozy\u201d kitchen actually a closet? homefeed adds the human layer \u2014 real reactions, real opinions, real talk. We\u2019re not replacing listing sites; we\u2019re adding the conversation they\u2019re missing.",
  },
  {
    question: "Can I list my property on homefeed?",
    answer:
      "Not directly \u2014 at least not yet. homefeed aggregates listings from public real estate data sources. We\u2019re focused on the social commentary experience right now, but we\u2019re exploring ways to let homeowners and agents engage with their listings in the future. Stay tuned!",
  },
  {
  ...
  {
    question: "Is homefeed free?",
    answer:
      "Yes! homefeed is completely free to browse, comment, and react. No account required, no paywall, no premium tier. We believe real estate commentary should be accessible to everyone. We may introduce optional premium features in the future, but the core social experience will always be free.",
  },
  {
    question: "How do I report inappropriate content?",
    answer:
      "We take content moderation seriously. If you see a comment that contains hate speech, harassment, spam, or otherwise violates our Terms of Service, please email us at support@homefeed.app with the listing URL and a description of the issue. We review all reports and take action promptly. We\u2019re also working on in-app reporting tools.",
  },
  {
    question: "Where do listings come from?",
    answer:
      "Listings on homefeed are aggregated from publicly available real estate data sources. We pull listing details like address, price, photos, and property specs from these sources and display them alongside our social features. Listing data may not always be perfectly up-to-date \u2014 always verify details with the listing agent or source before making any decisions.",
  },
  {
...
export default function FAQPage() {
  ...
  return (
    <>
      ...
      <title>FAQ — homefeed</title>
      <meta
        name="description"
        content="Frequently asked questions about homefeed, the social commentary platform for real estate."
      />
