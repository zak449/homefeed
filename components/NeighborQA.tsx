      ...
      {showForm && (
        <div className="mb-6 bg-surface border border-divider rounded-card p-5 animate-fade-in">
          <form onSubmit={handlePost} className="space-y-3">
            ...
            {postError && (
              <p className="text-caption text-red-600 bg-red-50 border border-red-100 rounded-lg px-3 py-2">
                {postError}
              </p>
            )}
                      ...
                      <div className="flex items-center gap-2 mt-2 flex-wrap">
                        ...
                        <span
                          className={`text-[11px] font-medium px-2 py-0.5 rounded-full ${
                            {
                              property: "bg-blue-50 text-blue-600 border border-blue-100",
                              block: "bg-purple-50 text-purple-600 border border-purple-100",
                              area: "bg-green-50 text-green-600 border border-green-100",
                              schools: "bg-yellow-50 text-yellow-700 border border-yellow-100",
                              safety: "bg-red-50 text-red-600 border border-red-100",
                        ...
                        {q.answers.map((a) => (
                          <div key={a.id} className="px-5 py-4">
                            <div className="flex items-center gap-2 mb-1.5">
                              ...
                              {a.isVerifiedLocal && (
                                <span className="inline-flex items-center gap-1 text-[10px] font-semibold px-1.5 py-0.5 rounded-md bg-green-50 text-green-700 border border-green-200">
