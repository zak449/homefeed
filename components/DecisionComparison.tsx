...
function sentimentBadge(sentiment: Sentiment) {
  switch (sentiment) {
    ...
    case "positive":
      return (
        <span className="inline-flex items-center gap-1 text-xs font-semibold bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded-full">
          <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    default:
      return (
        <span className="inline-flex items-center gap-1 text-xs font-semibold bg-surface text-tertiary px-2 py-0.5 rounded-full">
          Neutral
        </span>
      );
  }
    ...
    <div className="bg-surface rounded-card border border-divider shadow-soft overflow-hidden">
      ...
      <div className="mx-5 mb-4 p-4 bg-highlight rounded-xl">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-medium tracking-wider uppercase text-tertiary">
            Community Pulse
          </span>
        ...
        <div className="flex items-center gap-3">
          {analysis!.positiveCount > 0 && (
            <div className="flex items-center gap-1.5 bg-surface/80 px-2.5 py-1.5 rounded-lg">
              ...
              <div>
                <p className="text-xs font-medium text-ink">{analysis!.positiveCount}</p>
          ...
          {analysis!.warningCount > 0 && (
            <div className="flex items-center gap-1.5 bg-surface/80 px-2.5 py-1.5 rounded-lg">
              ...
              <div>
                <p className="text-xs font-medium text-ink">{analysis!.warningCount}</p>
          ...
          {analysis!.neutralCount > 0 && (
            <div className="flex items-center gap-1.5 bg-surface/80 px-2.5 py-1.5 rounded-lg">
              ...
              <div>
                <p className="text-xs font-medium text-ink">{analysis!.neutralCount}</p>
      ...
      <div className="px-5 pb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-surface rounded-xl border border-divider p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-caption font-medium text-ink">Listing Description</h4>
          </div>
          {description ? (
        ...
        <div className="bg-amber/[0.04] rounded-xl border border-amber/20 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-caption font-medium text-ink">Neighbor Reality</h4>
          </div>
          <div className="bg-surface/80 rounded-lg p-3">
            <div className="flex items-center justify-between mb-1.5">
              <p className="text-xs text-tertiary font-medium">Most recent take</p>
      ...
      <div className="px-5 pb-5">
        <p className="text-xs text-tertiary uppercase tracking-wider mb-2.5">Neighbor Takes</p>
      ...
      <div className="px-5 py-3 bg-highlight/50 border-t border-divider flex items-center justify-between">
        ...
        <span className="text-xs font-medium tracking-wider uppercase text-amber">
          Community Intel
        </span>
      </div>
    </div>
