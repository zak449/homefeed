    ...
    <div className="relative">
      ...
      <div className="sm:hidden">
        ...
        <button
          ...
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 px-5 py-3 rounded-full bg-ink text-white text-sm font-bold shadow-elevated hover:opacity-90 active:scale-95 transition-all"
        >
          {showMobileMap ? (
            <>
