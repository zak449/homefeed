    ...
    html: `
      <div style="font-family: DM Sans, sans-serif; max-width: 600px; margin: 0 auto; background: #FAFAF7; padding: 40px; border-radius: 16px;">
        <div style="background: #FF6B6B; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
          <h1 style="color: white; font-size: 24px; margin: 0; font-family: Georgia, serif;">New Inquiry — gwakgwak</h1>
        </div>
        ...
        <p style="font-size: 12px; color: #999; margin-top: 32px;">Sent via <a href="#" style="color: #FF6B6B;">gwakgwak</a></p>
      </div>
    `,
  });
...
export async function sendReactionAlert({
  ...
  await resend.emails.send({
    from: FROM,
    to: recipientEmail,
    subject: `${reactorName} reacted to your comment on gwakgwak`,
    html: `
      <div style="font-family: DM Sans, sans-serif; max-width: 600px; margin: 0 auto; background: #FAFAF7; padding: 40px; border-radius: 16px;">
        <div style="background: #FFD93D; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
          <h1 style="color: #1A1A2E; font-size: 24px; margin: 0; font-family: Georgia, serif;">${reactionType} New reaction on gwakgwak</h1>
        </div>
        ...
        html: `
          <div style="font-family: DM Sans, sans-serif; max-width: 600px; margin: 0 auto; background: #FAFAF7; padding: 40px; border-radius: 16px;">
            <div style="background: #4D96FF; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
              <h1 style="color: white; font-size: 24px; margin: 0; font-family: Georgia, serif;">New comment on gwakgwak</h1>
            </div>
